...
const Footer = () => {
  return (
    <footer className="bg-[#F5F0BF] text-[#333333] mt-12">
      <div className="container mx-auto px-6 py-10 grid gap-8 sm:grid-cols-2 md:grid-cols-4">
        ...
        <div className="space-y-3">
          ...
          <p className="text-sm leading-relaxed">
            Discover curated products inspired by Egyptian heritage and modern
            elegance. Quality, variety and a graceful shopping experience — all
            in one place.
          </p>
          <div className="flex items-center gap-3 mt-3">
            <span className="p-2 rounded-full hover:bg-white/50 transition">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <a href="#" className="hover:text-[#C3A27B] transition">
                Shop
              </a>
            </li>
            <li>
        ...
        <div>
          ...
          <div className="mt-4 text-xs text-gray-600">
            ...
            <a href="#" className="underline hover:text-[#C3A27B]">
              Privacy Policy
            </a>
            .
          </div>
      ...
      <div className="border-t border-white/60">
        <div className="container mx-auto px-6 py-4 flex flex-col md:flex-row items-center justify-between text-sm text-gray-600">
          <div className="mb-3 md:mb-0">
            © {new Date().getFullYear()} Lunora. All rights reserved.
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2 text-xs">
              ...
              <div className="flex items-center gap-2">
                <div className="w-8 h-5 bg-white/60 rounded-sm flex items-center justify-center text-[10px]">
                  VISA
                </div>
                <div className="w-8 h-5 bg-white/60 rounded-sm flex items-center justify-center text-[10px]">
                  MC
